      ...
      <div style={{flex:1,overflowY:'auto',padding:'12px 14px'}}>
        ...
        {tab==='identity' && (
          <div style={{display:'flex',flexDirection:'column',gap:9}}>
            ...
            <div style={S.field}><label style={S.label}>Faction</label><input style={S.fieldInput} value={form.faction} onChange={e=>set('faction',e.target.value)} placeholder="Faction or affiliation…"/></div>
            <div style={S.field}><label style={S.label}>Tags</label>
    ...
    <div style={S.root}>
      ...
      {selectedNpc&&selectedCity&&(
        <div style={S.drawer}>
          ...
          <div style={S.field}><label style={S.label}>Faction</label><input style={S.fieldInput} value={selectedNpc.faction||''} onChange={e=>updateNpcField(selectedNpc.id,'faction',e.target.value)} placeholder="Faction or affiliation…"/></div>
