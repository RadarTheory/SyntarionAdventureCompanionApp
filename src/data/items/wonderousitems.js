export const wonderousitems = [
  // WONDROUS ITEMS — CONTAINER
  ...
  { category: 'Wondrous Items', type: 'Container', name: 'Cabinet of Whispered Inventory', desc: 'A folding wooden cabinet that softly whispers the location of misplaced stored items when opened at night.', tags: ['wondrous','inventory'], meta: 'effect: locate storage' },
  { category: 'Wondrous Items', type: 'Container', name: 'Traveler’s Spice Tube', desc: 'A brass spice tube that somehow always contains enough seasoning to improve bland camp meals.', tags: ['wondrous','food'], meta: 'effect: seasoning' },
  ...
  { category: 'Wondrous Items', type: 'Held', name: 'Candle of One True Shadow', desc: 'A pale wax candle whose flame always reveals the shadow of hidden doors, alcoves, or compartments.', tags: ['wondrous','exploration'], meta: 'effect: reveal hidden spaces' },
  { category: 'Wondrous Items', type: 'Held', name: 'Stone of Distant Rain', desc: 'A smooth river stone that becomes damp several hours before nearby storms.', tags: ['wondrous','weather'], meta: 'effect: storm prediction' },

  // WONDROUS ITEMS — RELIC
  ...
  { category: 'Wondrous Items', type: 'Utility', name: 'Pocket Hearthstone', desc: 'A smooth black stone that radiates faint campfire warmth when wrapped in cloth overnight.', tags: ['wondrous','survival'], meta: 'effect: warmth' },
  { category: 'Wondrous Items', type: 'Utility', name: 'Bookmark of Returning Pages', desc: 'A ribbon bookmark that always opens a book back to the last emotionally significant page.', tags: ['wondrous','memory'], meta: 'effect: emotional recall' },

  // WONDROUS ITEMS — WEARABLE
