    ...
    switch (activeTab) {
          ...
          <div>
            ...
            {mapUrl ? (
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "'Cinzel', serif", fontSize: 11, color: COLORS.muted, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  No map set
                </div>
                <div style={{ fontSize: 11, color: COLORS.dim, fontFamily: 'Georgia, serif', fontStyle: 'italic', marginTop: 6 }}>
                  The DM can add a map from DM Mode.
                </div>
              </div>
            )}
          </div>
                ...
                {roster.map(char => {
                  ...
                  return (
                    <div key={char.id} style={{
                      ...
                      <div>
                        <div style={{ fontFamily: "'Cinzel', serif", fontSize: 13, fontWeight: 700, color: COLORS.text, marginBottom: 3 }}>
                          {char.name || 'Unnamed'}
                        </div>
              ...
              <div style={{ marginTop: 20, paddingTop: 16, borderTop: `1px solid ${COLORS.border}` }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 6, padding: '10px 24px', cursor: assigning ? 'default' : 'pointer',
                    fontFamily: "'Cinzel', serif", fontSize: 10,
                    letterSpacing: '0.12em', textTransform: 'uppercase',
                    color: COLORS.magicText, fontWeight: 700,
      ...
      case 'Sheet':
        return userChar ? (
          ...
          <div style={{ color: COLORS.dim, fontFamily: 'Georgia, serif', fontStyle: 'italic', fontSize: 12 }}>
            No character loaded.
          </div>
        );
    ...
    <div style={{ minHeight: '100vh', background: COLORS.wizard, display: 'flex', flexDirection: 'column', fontFamily: 'Georgia, serif', color: COLORS.text }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontFamily: "'Cinzel', serif", fontSize: isMobile ? 10 : 12, fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: COLORS.text }}>
            {campaign.subtitle}
          </div>
          <div style={{ fontSize: 8, color: COLORS.dim, letterSpacing: '0.12em', textTransform: 'uppercase', fontFamily: "'Cinzel', serif" }}>
            {campaign.name}
          </div>
        </div>
        <div style={{ width: 60 }} />
...
// ─── INLINE CHARACTER SHEET (stats only for campaign view) ───────────────────
...
// MAIN EXPORT
// Props:
//   userChar  — the logged-in player's character object
//   onHome    — fn() back to Landing
//   onAssign  — fn(campaignId) called when character is assigned
// ═════════════════════════════════════════════════════════════════════════════
