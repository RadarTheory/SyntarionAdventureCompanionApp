...
export const COLORS = {
  ...
  tech:       '#4A88B8',
  techDim:    '#2A5888',
  techBg:     'rgba(42,88,136,0.10)',
  techText:   '#80B8D8',
  deity:      '#8d7aa8',
  deityDim:   '#665587',
  deityBg:    'rgba(141,122,168,0.08)',
  deityText:  '#bcadd4',
  arch:       '#b8a06a',
  archDim:    '#8a7648',
  archBg:     'rgba(184,160,106,0.08)',
  archText:   '#d6c69a',
  spirit:     '#c46a3a',
  spiritDim:  '#8f4a26',
  spiritBg:   'rgba(196,106,58,0.08)',
  spiritText: '#dda279',
  unaffiliated:     '#7c756b',
  unaffiliatedBg:   'rgba(124,117,107,0.08)',
  unaffiliatedText: '#b0a89c',
  text:       '#f0eeeb',
  textSub:    '#dfd2c4',
  muted:      '#b3a89c',
  dim:        '#837364',
