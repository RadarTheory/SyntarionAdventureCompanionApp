  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(rgba(10,8,6,0.74), rgba(10,8,6,0.74)), radial-gradient(ellipse at center, rgba(240,238,235,0.08), rgba(10,8,6,0.18) 62%, rgba(10,8,6,0.34))',
        zIndex: 100,
    ...
    >
      ...
      >
        ...
        <input
          ...
          placeholder={mode === 'create' ? 'Set the sigil (min 6 chars)' : 'Enter sigil'}
          style={{
            width: '100%', background: 'rgba(240,238,235,0.06)',
